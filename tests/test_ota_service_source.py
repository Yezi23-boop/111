...
class OtaServiceSourceTests(unittest.TestCase):
    def test_service_uses_bounded_queue_and_ui_readiness(self) -> None:
        ...
        self.assertNotIn("onenet_ota_provider.h", source)
        self.assertNotIn("onenet_task_valid", source)
        ...
        self.assertIn("check ignored while state=", source)
    ...
    def test_view_keeps_lvgl_calls_in_ui_owner_and_uses_safe_zone(self) -> None:
        ...
        self.assertIn("lv_obj_set_pos(prepare, 40, 320)", source)
        self.assertIn("lv_obj_set_pos(cancel, 210, 320)", source)
    ...
    def test_transport_enforces_manifest_and_finish_admission_contract(self) -> None:
        ...
        self.assertIn("OTA_UPDATE_CHECKSUM_MD5", source)
        ...
        self.assertIn("ota_transport_verify_delta_patch_header(client, patch_header)", source)
        self.assertIn("size_t received = kOtaDeltaPatchHeaderBytes", source)
        self.assertIn("mbedtls_sha256_update(&patch_ctx, patch_header", source)
