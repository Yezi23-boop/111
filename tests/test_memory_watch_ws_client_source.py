...
class MemoryWatchWsClientSourceTests(unittest.TestCase):
    ...
    def test_service_uses_ws_only_inside_upload_worker_with_http_fallback(self) -> None:
        ...
        self.assertIn("memory_watch_ws_client_send_audio_start", source)
        self.assertIn("memory_watch_ws_client_send_audio_chunk", source)
        self.assertIn("memory_watch_ws_client_send_audio_end", source)
