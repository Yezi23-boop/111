...
class ImuServiceSourceTests(unittest.TestCase):
    ...
    def test_header_exposes_config_snapshot_getter_contract(self) -> None:
        ...
        self.assertIn("#define IMU_SERVICE_EVENT_PRE_FRAMES 75U", header)
        self.assertIn("#define IMU_SERVICE_EVENT_POST_FRAMES 175U", header)
    ...
    def test_service_uses_imu_sensor_and_owns_gpio21_isr(self) -> None:
        ...
        self.assertIn("k_event_acc_norm_high_mps2 = 21.57f", source)
        self.assertIn("k_event_gyro_norm_high_radps = 3.84f", source)
        self.assertIn("k_event_jerk_high_mps2_per_frame = 5.39f", source)
