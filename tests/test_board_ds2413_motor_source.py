...
class BoardDs2413MotorSourceTests(unittest.TestCase):
    def test_main_build_wires_board_motor_and_onewire_dependency(self) -> None:
        ...
        self.assertIn("app/board_ds2413_motor.c", cmake)
